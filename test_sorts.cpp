...
void test_priority_queue_sort_int()
{
    Test("test_priority_queue_sort_int");
    vector<int> v;
    assert(v.size() == 0);
...
void test_priority_queue_sort_string()
{
    Test("test_priority_queue_sort_string");
    vector<string> v;
    assert(v.size() == 0);
    priority_queue_sort(v);
    assert(is_sorted(v));
...
//template <typename T>
void bubTest(int N, ofstream &file)
{
    vector<int> v = rand_vec(N, 1, N);
    file << bubble_sort(v).to_csv() << endl;
    if (N == 2000)
    {
       assert(is_sorted(v));
    } 
...
void insertTest(int N, ofstream &file)
{
    vector<int> v = rand_vec(N, 1, N);
    file << insertion_sort(v).to_csv() << endl;
    if (N == 2000)
    {
        assert(is_sorted(v));
    } 
...
void selectTest(int N, ofstream &file)
{
    vector<int> v = rand_vec(N, 1, N);
    file << selection_sort(v).to_csv() << endl;
    if (N == 2000)
    {
        assert(is_sorted(v));
    } 
...
void mergeTest(int N, ofstream &file)
{
    vector<int> v = rand_vec(N, 1, N);
    file << merge_sort(v).to_csv() << endl;
    if (N == 2000)
    {
        assert(is_sorted(v));
    } 
...
void quickTest(int N, ofstream &file)
{
    vector<int> v = rand_vec(N, 1, N);
    file << quick_sort(v).to_csv() << endl;
    if (N == 2000)
    {
        assert(is_sorted(v));
    } 
...
void shellTest(int N, ofstream &file)
{
    vector<int> v = rand_vec(N, 1, N);
    file << shell_sort(v).to_csv() << endl;
    if (N == 2000)
    {
        assert(is_sorted(v));
    } 
...
void heapTest(int N, ofstream &file)
{
    vector<int> v = rand_vec(N, 1, N);
    file << priority_queue_sort(v).to_csv() << endl;
    if (N == 2000)
    {
        assert(is_sorted(v));
    } 
...
void iquickTest(int N, ofstream &file)
{
    vector<int> v = rand_vec(N, 1, N);
    file << iquick_sort(v).to_csv() << endl;
    if (N == 2000)
    {
        assert(is_sorted(v));
    } 
...
int main()
{
    ...
    test_priority_queue_sort_int();
    test_priority_queue_sort_string();
    ...
    for (int i = 1; i < 26; i++)
    {
        //bubTest(2000*i, MyFile);
        //insertTest(2000*i, MyFile);
        //selectTest(2000*i, MyFile);
        //mergeTest(2000*i, MyFile);
        //quickTest(2000*i, MyFile);
        //shellTest(2000*i, MyFile);
        //heapTest(2000*i, MyFile);
        iquickTest(2000*i, MyFile);
    }
